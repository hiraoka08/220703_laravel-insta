...
<div class="row border shadow" style="margin-top: 100px">
        ...
        <div class="card border-0">
            <div class="card-header bg-white py-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <!-- If you are the owner of the post, you can Edit or Delete thie post -->
                        ...
                        @if (Auth::user()->id === $post->user->id)                                
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <button type="submit" class="dropdown-item text-danger" data-bs-toggle="modal" data-bs-target="#delete-post-{{ $post->id }}">
                ...
                <div class="mt-4">
                    <form action="{{ route('comment.store', $post->id) }}" method="post">
                        ...
                        <div class="input-group">
                            <textarea name="comment_body{{ $post->id }}" rows="1" class="form-control form-control-sm" placeholder="Add a comment..." style="overflow:hidden">{{ old('comment_body' . $post->id) }}</textarea>
                    ...
                    @if ($post->comments->isNotEmpty())
                        ...
                        @foreach ($post->comments as $comment)
                            <li class="list-group-item border-0 p-0 mb-2">
                                ...
                                <form action="{{ route('comment.deleteComment', $comment->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
