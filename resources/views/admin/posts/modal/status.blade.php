        ...
        <div class="modal-dialog">
            <div class="modal-content border-primary">
                ...
                <div class="modal-body">
                    <p class="fw-bold">Are you sure you want to unhide this post?</p>
                    <img src="{{ asset('/storage/images/' . $post->image) }}" alt="{{ $post->image }}" class="admin-posts-image">
    ...
    <div class="modal fade" id="hide-post-{{ $post->id }}">
        <div class="modal-dialog">
            <div class="modal-content border-danger">
                ...
                <div class="modal-body">
                    <p class="fw-bold">Are you sure you want to hide this post?</p>
                    <img src="{{ asset('/storage/images/' . $post->image) }}" alt="{{ $post->image }}" class="admin-posts-image">
                    <p class="mt-2">{{ $post->description }}</p>
                </div>
                <div>
